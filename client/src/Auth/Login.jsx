                ...
                <div>
                        ...
                        <div>
                            <div className="fill-in">
                                <div>
                                    ...
                                    <Row>
                                        { invalidCredentialsMessage && (<Label basic color='red'
                                                                               pointing='left'>{ invalidCredentialsMessage }</Label>) }
                                    </Row>
                    ...
                    { enterMFA && !logInStatus && (
                        <div>
                            <div className="fill-in">
                                <Form.Field>
                                    <Input type="text" icon="hashtag" iconPosition="left"
                                    ...
                                    { invalidCredentialsMessage &&
                                    <Label basic color='red' pointing='left'>{ invalidCredentialsMessage }</Label> }
                                </Form.Field>
                            </div>
                            <div className='button-holder'>
                                <Button primary fluid onClick={ this.sendVerificationCode }>Validate</Button>
                                { enableResend && (
                                    <Button fluid color="purple" onClick={ this.signInCustomer }>Resend it!</Button>)}
